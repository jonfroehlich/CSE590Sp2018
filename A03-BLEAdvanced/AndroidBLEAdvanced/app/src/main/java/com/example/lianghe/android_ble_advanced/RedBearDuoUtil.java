...
public class RedBearDuoUtil {

  public static final int REQUEST_BLUETOOTH_PERMISSIONS = 1;
  public static final int REQUEST_ENABLE_BLUETOOTH = 0;

  /**
   * Returns a value indicating whether connection to a RedBear Duo board is supported on this
   * Android device.
   */
   ...
   *
   * <p>Because connecting to the RedBear Duo board requiring scanning for BLE devices, the user
   * must grant the ACCESS_COARSE_LOCATION permission.
   */
  ...
  /**
   * Requests that the user grant the required permissions to connect to the RedBear Duo board.
   *
   * <p>Because connecting to the RedBear Duo board requiring scanning for BLE devices, the user
   * must grant the ACCESS_COARSE_LOCATION permission.
   *
  ...
  private static @Nullable BluetoothAdapter getBluetoothAdapter(Context context) {
