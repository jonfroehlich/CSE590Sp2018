 ...
 *
 * Originally by Google, see: https://github.com/googlesamples/android-vision. More specifically:
 *   - https://github.com/googlesamples/android-vision/tree/master/visionSamples/FaceTracker
 *
 * See also a Google Code Lab tutorial:
 *   - https://codelabs.developers.google.com/codelabs/face-detection/index.html#0
 *
 * Updated by Jon Froehlich. Primary updates include:
 *  - Fixed CameraSourcePreview so that the preview fills the whole screen
 *  - Added in "Flip" button support to enable user to choose between front-facing and rear camera
 * Both of the above updates copy/pasted code from the Googly Eyes code sample:
